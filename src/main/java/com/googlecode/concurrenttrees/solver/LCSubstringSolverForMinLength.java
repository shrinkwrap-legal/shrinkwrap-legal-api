 ...
 */
public class LCSubstringSolverForMinLength {
    ...
    class ConcurrentSuffixTreeImpl<V> extends ConcurrentRadixTree<V> {
         ...
         */
        List<CharSequence> getLongestCommonSubstring(int minLengthOfSubstrings) {
            List<CharSequence> encounteredSubstrings = new ArrayList<>();
            ...
            for (NodeKeyPair nodeKeyPair : lazyTraverseDescendants("", root)) {
                if (nodeKeyPair.key.length() > minLengthOfSubstrings
     ...
     */
    public LCSubstringSolverForMinLength(NodeFactory nodeFactory) {
     ...
     * @return The longest common substring
     */
    public List<CharSequence> getLongestCommonSubstringsForLength(int minLengthOfSubstrings) {
        return suffixTree.getLongestCommonSubstring(minLengthOfSubstrings);
    }
